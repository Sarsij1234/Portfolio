  ...
  return (
    ...
    className="max-w-screen-2xl container mx-auto px=4 md:px-20 my-20 ">
     ...
     <ul >
       ...
       <br/>
       <li className=""><h1 className="font-semibold my-0 text-black">Intermediate:</h1>Raj Madhav Shree Inter Collge, Ayodhya 
       <br/>Physics, Chemistry, Maths [PCM]</li>
       <br/>
       <li className=""><h1 className="font-semibold my-0 text-black">High School:</h1>Raj Madhav Shree Inter Collge, Ayodhya 
       <br/>Physics, Chemistry, Maths [PCM]</li>
        ...
        <p className="text-justify mx-3"> As a dedicated Frontend Developer, I specialize in creating dynamic and responsive web
         ...
         user interfaces that provide seamless experiences across devices. With a strong foundation in web development, I have
          ...
          <br/>
          <h1 className="text-black font-bold text-3xl underline">Skills & Experties</h1>
          ...
          <br/>
          <br/>
          <h1 className="text-3xl font-bold text-black my-0 underline">Achievements And Awards</h1>
